...
export default function EventsPage() {
  ...
  const events: Event[] = [
    ...
    },
    {
      ...
      detailedDescription:
        "Intellify 2.0 /HTM 5.0 was designed as an intensivehackathon that brought together 350 enrolled students to address complex real-world problems. Far from a lecture or workshop, the event required teams to interpret open-endedchallenges and devise practical solutions that could have real community or industry impact. Participants were provided with problem statements that spanned various domains—fromimproving local infrastructure to enhancing sustainable practices—with the goal of generating actionable prototypes. The hackathon fostered an atmosphere of creative urgency, where students worked under tight deadlines, engaging in continuous iterations and testing their ideas against real-world constraints. Regular progress updates, peer reviews, and mentor feedback sessions enabledteams to refine their strategies and overcome obstacles collaboratively. The outcome wasevident in the innovative solutions that emerged from the intense, hands-on problem-solvingprocess, leaving participants with a deeper understanding of how to translate ideas intoreal-world applications and a strengthened capability for teamwork under pressure.",
    ...
    {
      id: 4,
      title: "RoboComp & Go Drone",
      date: "March 4th & 5th, 2025",
      location: "Football Ground",
      description: "A non-technical race where 45 students competed in a timed challenge using a custom- built Bluetooth car.",
      detailedDescription:
        "The March 2025 edition of RoboComp & GoDrone saw 60+ enrolled teams engage in an exhilarating race-against-time event. Participants did not work on technical construction; instead, they focused on strategy andrapid decision-making to navigate a challenging race track using a small Bluetoothcar developed by the organizers. Multiple rounds of timed races allowed teams to experiment with different tactics, adapt quickly to course challenges, and refine their strategies between heats. The event emphasizedteamwork, speed, and precision, creating an energetic atmosphere where sportsmanshipandcreative strategies took center stage. The outcome was a vibrant display of coordinatedteamwork and quick thinking, with participants leaving the event both energized and moreadept at planning under pressure.",
    ...
    },
    {
      ...
      detailedDescription:
        "The Introduction to Jetson Nano event featured 95 enrolled students exploring the potential of edge computing through a hands-on approach. The session began with an explanation of the Jetson Nano's architecture and its relevanceindeploying lightweight AI models. Detailed tutorials covered initial setup, environment configuration, and installation of essential libraries, bridging theoretical concepts with practical implementation. Students were then engaged in a series of labs that included object detection, image classification, and real-time data processing. Step-by-step instructions allowed each participant to build, test, and optimize AI-powered applications on the Jetson Nano. The atmosphere was highly interactive, with the coordinator providing in-depth explanations of each configuration step and encouraging peer-to-peer troubleshooting. The comprehensive format ensuredthat theoutcome was not only an increased familiarity with edge computing but also a renewedenthusiasm for developing autonomous applications on resource-constrained platforms.",
    ...
    },
    {
      ...
      detailedDescription:
        "The drone-building workshop welcomed 53 enrolled students for a comprehensive, hands-on experience. The event began with a detailedbreakdown of the essential drone components—from selecting appropriate motors and propellers to understanding the intricacies of wiring and power management. Through a series of guided demonstrations, participants learned how to assemble the mechanical components with precision while integrating the necessary electronic systems. The workshop then moved on to cover crucial aspects of firmware configuration and flight stabilization. Students received individual guidance as they encountered and resolved challenges such as balancing the drone and calibrating sensors accurately. Extensive groupdiscussions and follow-up Q&A sessions enriched the session, ensuring that every student could follow and replicate the steps independently. The resultant outcome was a tangibleimprovement in technical skills and confidence, as each participant emerged with the foundational knowledge needed to not only build but also troubleshoot and pilot their owndrone.",
    ...
    },
    {
      ...
      detailedDescription:
        "The Image Processing Workshop drew 80+ enrolled students into the expansive field of computer vision. The workshop began with an in-depthdiscussion of the principles behind image capture, processing methods, and techniques for edge detection and noise reduction. Interactive modules enabled participants to visualizethe transformation of raw images into processed outputs using popular libraries. Hands-on exercises provided opportunities for students to engage with various filteringtechniques and experiment with image segmentation algorithms. The structured lab sessions allowed learners to manipulate images, optimize parameters, and compare outcomes in real time. Frequent assessments and collaborative troubleshooting sessionsenriched the learning process. The conclusive outcome was a deepened practical understanding of image processing methodologies, preparing students to apply these techniques in research or industry projects that rely on advanced computer vision capabilities..",
    ...
    },
    {
      ...
      detailedDescription:
        "Intelify 1.0 gathered 250 enrolled students for a dynamic hackathon where the focus was on addressing practical challenges in areas suchassustainability, urban development, and community improvement. Participants worked inteams, received a concise brief outlining a real-world problem, and were tasked to ideate and develop prototypes that offered tangible, implementable solutions. The competitive atmosphere encouraged rapid brainstorming, creative resourcefulness, and collaborative problemsolving. Throughout the event, periodic checkpoints allowed teams to present their progress, shareinsights, and receive guidance from mentors and the coordinator. This structured feedbackloop, combined with the pressure of a tight timeline, pushed the students to think critically and act decisively. The outcome was a series of innovative projects that demonstrated the potential of technology to address everyday challenges, equipping participants with valuable skills inrapid prototyping and real-world problem solving.",
      image: "/images/intellify.jpg",
      category: "Hackathon",
    },
    {
      ...
      detailedDescription:
        "This event attracted 180 enrolled students who gathered to explore the expansive realm of artificial intelligence. The series commencedwithengaging lectures that introduced core AI principles, including machine learning fundamentalsand neural network design. Expert speakers illustrated the technology's impact across industries such as healthcare, finance, and transportation, while attendees participated ininteractive discussions to better understand AI's evolving capabilities. Throughout the day, sessions delved into detailed case studies and hands-on exercises that showcased the practical applications of AI. Students had the opportunity to experiment withdata sets and witness live demonstrations of algorithmic processing and predictive modeling. This comprehensive approach not only deepened participants' theoretical knowledge but alsoprovided actionable insights into deploying AI in real-world projects. The session's outcomewas a broadened perspective on modern technological challenges, empowering studentstoenvision and initiate innovative AI-driven solutions in their future endeavors.",
    ...
    },
    {
      ...
      detailedDescription:
        "The 3D Printing event attracted 70+ enrolled students eager to learn about rapid prototyping through additive manufacturing. The workshopstarted with a comprehensive review of the hardware components of a 3D printer and thevarious materials available for printing. In addition, attendees were introduced to slicingsoftware and the steps required for converting digital designs into printable instructions. Detailed live demonstrations allowed participants to witness the transformation of digital designs into physical objects. The event provided multiple hands-on sessions where studentscalibrated printers, addressed common printing issues, and experimented with various design adjustments. Through interactive feedback and real-time problem-solving, attendees learnedbest practices and innovative techniques in 3D printing. The improved understanding of theprocess resulted in a highly practical outcome: students left with the skills necessary tocreateprototypes and refine designs independently, ready to face real-world manufacturing challenges.",
    ...
    },
    {
      ...
      detailedDescription:
        "The Build using Arduino workshop provided an immersive experience for 80+ enrolled students. The day began with a review of fundamental Arduino programming concepts, followed by brainstorming sessions where students conceptualizedtheir own project ideas. Throughout the workshop, teams worked in a supportive environment to design and prototype projects that incorporated both sensor inputs and motor controls. Detailed troubleshooting sessions were integral, as they allowed participants to identify andcorrect issues on the fly. In the subsequent sessions, the coordinator offered targeted advice and hands-on guidanceonintegrating various modules and managing power supplies, ensuring that each project met itsintended goals. The multifaceted approach fostered a comprehensive learning environment where theoretical knowledge was directly applied to practical challenges. Ultimately, the outcome was a collection of innovative projects that not only demonstrated technical prowessbut also boosted each student's confidence in their ability to handle complex engineeringtasks, preparing them for advanced technological challenges",
          ...
          >
            <div className="p-6">
              ...
              <div className="mt-8 pt-4 border-t border-border">
                <Button className="w-full rounded-full" onClick={() => window.open('https://unstop.com/hackathons/intellify-national-level-hackathon-30-marwadi-university-mu-gujarat-1465258?lb=r6xqGNLB&utm_medium=Share&utm_source=shortUrl', '_blank')}>
                  Learn More
                </Button>
              </div>
            </div>
